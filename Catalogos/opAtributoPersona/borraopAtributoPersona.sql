 ...
 */
 ...
 CREATE PROCEDURE borraopAtributoPersona( IN iAtributoPer   INTEGER,
 	...
 	borraopAtributoPersona:BEGIN
		...
		/*	IF NOT EXISTS(SELECT * FROM ctPersona WHERE ctPersona.iIDTipoPersona = iIDTipoPersona
			...
			IF NOT EXISTS(SELECT * FROM opAtributoPersona WHERE opAtributoPersona.iAtributoPer = iAtributoPer
 				...
 				THEN 
 					SET lError = 1; 
 					SET cError = "El Atributo persona ya fue borrado con anterioridad";
 					LEAVE borraopAtributoPersona;
