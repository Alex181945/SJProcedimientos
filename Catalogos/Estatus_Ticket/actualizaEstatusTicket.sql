 ...
 CREATE PROCEDURE actualizaEstatusTicket(	IN iIDEstado      INTEGER,
     ...
     /*Manejo de Errores*/ 
		...
		START TRANSACTION;
			...
			IF NOT EXISTS(SELECT * FROM ctEstatusTicket WHERE ctEstatusTicket.iIDEstado = iIDEstado)
			...
			UPDATE 	ctEstatusTicket
					SET 	ctEstatusTicket.cEstado     	= cEstado,
							ctEstatusTicket.lActivo         = lActivo,
