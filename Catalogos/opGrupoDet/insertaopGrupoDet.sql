 ...
 */
 ...
 CREATE PROCEDURE insertaopGrupoDet( IN iGrupo VARCHAR(100),
 	...
 	insertaopGrupoDet:BEGIN
		...
		/*	IF EXISTS(SELECT * FROM ctPersona WHERE ctPersona.iIDTipoPersona = iIDTipoPersona)
			...
			INSERT INTO opGrupoDet(opGrupoDet.iGrupo,
									opGrupoDet.iTipoPersona,
									opGrupoDet.iPersona,
									opGrupoDet.iMateria,
									opGrupoDet.lActivo,
									opGrupoDet.dtCreado)
