 ...
 */
 ...
 /*Para pruebas*/
 USE escuelast;
 DROP PROCEDURE IF EXISTS `consultaGeneraKardexGral`;

 /*Delimitador de bloque*/
 DELIMITER //

 CREATE PROCEDURE consultaGeneraKardexGral(	IN iPersona   INTEGER(11) ,
 										OUT lError    TINYINT(1), 
 										OUT cSqlState VARCHAR(50), 
 										OUT cError    VARCHAR(200))
 	consultaGeneraKardexGral:BEGIN
...
/*Procedimiento*/
			...
			IF iPersona = 0 OR iPersona = NULL
				...
				THEN 
					...
					LEAVE consultaGeneraKardexGral;

			END IF;

			SELECT opCalificacion.*, ctMateria.cMateria
				FROM opCalificacion 
